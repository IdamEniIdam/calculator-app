...
import { calculate as calculateAPI } from '../Api'; // Rename the imported function to avoid conflicts
...
export default function Calculator() {
  ...
  const calculate = async () => { // Make the calculate function asynchronous
    try {
      const calculationResult = await calculateAPI(result); 
      // const calculationResult = await calculateAPI(math.evaluate(result).toString()); 
